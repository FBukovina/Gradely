...
This describes the source in this checkout. Backend rollout and legacy-password cleanup requirements are documented in [Bakaláři password migration](Docs/BackendPasswordMigration.md). Publishing a source release does not deploy the backend or publish the privacy policy.
